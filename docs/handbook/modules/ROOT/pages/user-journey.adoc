...
| `blueprintDiagram("…")` | `DiagramType.BLUEPRINT` | All four layers + dividing lines + phases
| `journeyDiagram("…")` | `DiagramType.JOURNEY` | Customer lane only + phases + optional emotion curve
|===

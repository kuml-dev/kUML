= Profiles
:description: Stereotypes, tagged values, and the built-in AUTOSAR/JavaEE/Spring/OpenAPI/SoaML profiles.
...
AUTOSAR Classic Platform R22-11 modeled as type-safe Kotlin. Five stereotypes cover
software components, communication interfaces, ports, runnables and behavior specs:

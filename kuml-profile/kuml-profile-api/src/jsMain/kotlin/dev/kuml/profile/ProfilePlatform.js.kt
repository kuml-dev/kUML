...
// Classpath discovery is a JVM-only concept — no ServiceLoader equivalent on JS.
...
// No generic reflection-based enum check available for an arbitrary KClass on JS.

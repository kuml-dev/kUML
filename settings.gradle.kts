...
include(
    ...
    "kuml-runtime:kuml-runtime-tokenflow", // ADR-0015 — Token-Flow-Ausführungs-Engine (UML-Aktivität + BPMN-Prozess)
...
include(
    ...
    "kuml-io:kuml-io-arxml",           // V3.1.33 — AUTOSAR Classic ARXML (XML) Import/Export, JVM-only (JDOM2), NICHT in Native-Image-CLI
...
include(
    ...
    "kuml-plugin-examples:plugin-reverse-csharp",  // V3.1.40 — Drittanbieter C# Reverse-Plugin

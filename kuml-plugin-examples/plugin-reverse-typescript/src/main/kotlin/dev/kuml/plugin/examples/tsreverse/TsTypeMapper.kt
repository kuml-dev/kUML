...
internal class TsTypeMapper {
    ...
    fun map(tsType: String): String = mapInternal(tsType = tsType, depth = 0)
    ...
    private fun mapInternal(
        ...
        return when {
            ...
            trimmed.contains(" | ") -> {
                ...
                if (nonNull.size == 1) mapInternal(tsType = nonNull[0], depth = depth + 1) else trimmed
            }
            else -> trimmed
        }
    }

...
class ElkLayoutEngineTest : FunSpec({
    ...
    test("direction LeftToRight orders nodes by x") {
        ...
        val xA = result.nodes[NodeId("A")]!!.bounds.origin.x
        val xB = result.nodes[NodeId("B")]!!.bounds.origin.x
        val xC = result.nodes[NodeId("C")]!!.bounds.origin.x

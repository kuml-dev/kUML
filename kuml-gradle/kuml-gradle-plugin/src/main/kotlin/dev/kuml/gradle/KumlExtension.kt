...
public abstract class KumlExtension
    ...
    constructor(
        ...
        /**
         * "Powered by kUML"-Wasserzeichen unten rechts (SVG/PNG). Default `false`
         * (opt-in) — unabhängig vom immer aktiven "Generated by kUML"-XML-
         * Kommentar, der in jeder erzeugten SVG steckt.
         */
        public val watermark: Property<Boolean> = objects.property(Boolean::class.java).convention(false)

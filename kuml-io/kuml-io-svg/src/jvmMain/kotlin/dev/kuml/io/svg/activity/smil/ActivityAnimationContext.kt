...
/**
 * Tuning parameters for Activity diagram animation.
 *
 ...
 * @param tokenColor Fill colour of the token circle travelling along flow edges.
 * @param highlightColor Fill colour applied to fork/join/decision nodes when activated.
 *
 * V3.1.31 — STM + Activity SMIL Renderers
 */
public data class ActivityAnimationContext(
    ...
    public companion object {
        ...
        /** Default context — blue token, amber highlight, 1× speed. */
        public val DEFAULT: ActivityAnimationContext = ActivityAnimationContext()
        ...
        internal fun requireSafeCssColor(
            ...
            require(isHex || isNamed) {
                "ActivityAnimationContext.$paramName must be a hex color (#rgb / #rrggbb / #rrggbbaa) " +

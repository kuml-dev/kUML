 ...
 * @param taskHighlightColor Fill colour applied to task rectangles during execution (light blue).
 * @param startEventColor Fill colour applied to start event circles when the token arrives (light green).
 * @param endEventColor Fill colour applied to end event circles when the token arrives (light red).
...
public data class BpmnAnimationContext(
    ...
    val taskHighlightColor: String = "#e3f2fd",
    val startEventColor: String = "#e8f5e9",
    val endEventColor: String = "#ffebee",
    ...
    public companion object {
         ...
         *
         * 200 repetitions at ~7 s/loop (5 s pass + 2 s gap) ≈ 23 minutes.
         * Keeps the generated SVG at a manageable size (~500 KB for the PdV example).
         */
        ...
        /** Default context — blue token, amber gateway, light-blue tasks, green/red events, 1× speed. */

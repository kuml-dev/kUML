...
// Note: person, softwareSystem, containerDiagram, relationship are methods on
// C4ModelBuilder — no imports needed (resolved via lambda receiver). Kotlin 2.4.0
// (K2) rejects spurious imports of non-existent top-level functions.

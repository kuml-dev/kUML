...
internal class RenderCommand : CliktCommand(name = "render") {
    ...
    private val watermark by option(
        "--watermark",
        help =
            "Render a small, theme-consistent 'Powered by kUML' label in the bottom-right corner " +
                "(SVG and PNG output). Off by default. Independent of the always-on " +
                "'Generated by kUML' XML comment embedded in every SVG.",
    ).flag()

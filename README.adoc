...
| *Phase 1*
| UML metamodel ✅ + UML DSL ✅ (5 diagram types), full C4, Kuiver rendering → SVG/PNG, themes
| 🚧 In Progress
...
kuml-core/
  ...
  kuml-core-dsl      ← DSL builder infrastructure (UML builders in dev.kuml.uml.dsl)
  kuml-core-script   ← Kotlin Scripting host + KumlScriptDefinition
kuml-metamodel/
  kuml-metamodel-uml ← UML 2.x sealed hierarchy + serialization (Phase 1 ✅)
